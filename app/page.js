  ...
  return (
    <main className="min-h-screen w-full">
      ...
      <section className="py-20 px-4">
        ...
        <div className="flex flex-wrap justify-center items-center gap-8">
          <Link target="_blank" className="dark:bg-gray-800 shadow-inner dark:shadow-gray-600 bg-gray-200 hover:opacity-90 backdrop-blur-xl shadow-gray-300 px-5 py-4 min-w-[200px] text-center rounded-xl " href={`https://wa.me/6285809011357`}>Whatsapp</Link>
          <Link target="_blank" className="dark:bg-gray-800 shadow-inner dark:shadow-gray-600 bg-gray-200 hover:opacity-90 backdrop-blur-xl shadow-gray-300 px-5 py-4 min-w-[200px] text-center rounded-xl " href={`mailto:ivantheo159@gmail.com`}>Gmail</Link>
        </div>
      </section>
    </main>
  );
